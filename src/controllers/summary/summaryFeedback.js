const SUCCESS_QUOTES_LIST = [
	...
	{ min:   4, max:   8, text: 'Seems legit, a bit of luck but no merit.'},
	{ min:   7, max:  10, text: 'Pretty good!'},
	{ min:   9, max:  10, text: 'That was short, but you made it!'},
	{ min:  10, max:  50, text: 'Trying random patterns is not a strategy...'},
	{ min:  10, max:  50, text: 'That was looooooooong.'},
	{ min:  10, max:  50, text: 'At least you made it.'},
	{ min:  10, max:  50, text: 'You must hate this game by now.'},
	{ min:  10, max:  50, text: 'I hope '},
	{ min:  41, max: 403, text: 'Your dedication is impressive.'},
	{ min:  50, max: 403, text: 'Your dedication is impressive.'},
...
const FAIL_QUOTES_LIST = [
	...
	'This not funny for you, but it is for me ;)',
